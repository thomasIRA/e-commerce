<template>
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4  border-gray-100 my-4" >
    <div v-for="(product, i) in inventory" :key="i" class=" w-full max-w-sm  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <img class="p-8 rounded-t-lg" :src="product.photo" :alt="product.name" :title="product.name"/>
      <div class="px-5 pb-5 text-center">
          ...
          <div class="flex items-center justify-between mt-2">
              <input type="number" v-model.number="product.qty" class="w-[80px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
